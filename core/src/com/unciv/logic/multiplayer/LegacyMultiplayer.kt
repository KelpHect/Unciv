...
/**
 * Provides explicit legacy save-file multiplayer functionality to the rest of
 * the game.
 ...
 *
 * API v3 must never call this service: its whole-save protocol is preserved
 * only for existing API-v1/v2 games.
 *
 * See the file of [com.unciv.logic.multiplayer.HasMultiplayerGameName] for all available [EventBus] events.
 */
class LegacyMultiplayer {
