...
- [ ] Add deterministic fresh-process parity fixtures for every command family,
  ...
  Fresh packaged-JVM evidence covers 61 operations: handshake, game creation,
  ...
  lifecycle (offer, counter, decline, retract, and accept), and event choice.
  ...
  time remain replay-critical. The other 25 operations plus additional random
