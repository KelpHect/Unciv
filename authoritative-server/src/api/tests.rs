...
fn openapi_covers_routes_security_and_closed_command_shapes() {
    ...
    let expected_paths = [
        ...
        "/api/v3/account",
        "/api/v3/friends",
        "/api/v3/friends/{username}",
        "/api/v3/friend-requests",
        ...
        "/api/v3/lobbies/{game_id}/start",
        "/api/v3/games/{game_id}",
        "/api/v3/games/{game_id}/rewind-checkpoints",
        "/api/v3/games/{game_id}/rewinds",
        "/api/v3/games/{game_id}/rewinds/current",
        "/api/v3/games/{game_id}/rewinds/{request_id}",
        "/api/v3/games/{game_id}/rewinds/{request_id}/vote",
