    ...
    pub async fn execute_set_unit_exploration(
        ...
        let proposal = worker
            ...
            .map_err(|error| match error {
                ...
                other => {
                    eprintln!("authoritative worker SetUnitExploration transport/protocol failure: {other}");
    ...
    pub async fn execute_cancel_unit_movement_order(
        ...
        let proposal = worker
            ...
            .map_err(|error| match error {
                ...
                other => {
                    eprintln!("authoritative worker CancelUnitMovementOrder transport/protocol failure: {other}");
                    CommitError::WorkerRevisionMismatch
                }
            })?;
        self.commit(actor_account_id, envelope, proposal).await
    ...
    pub async fn execute_move_unit_toward(
        ...
        let proposal = worker
            ...
            .map_err(|error| match error {
                ...
                other => {
                    eprintln!(
                        "authoritative worker MoveUnitToward transport/protocol failure: {other}"
                    );
                    CommitError::WorkerRevisionMismatch
                }
            })?;
    ...
    pub async fn execute_swap_units(
        ...
        let proposal = worker
            ...
            .map_err(|error| match error {
                ...
                other => {
                    eprintln!("authoritative worker SwapUnits transport/protocol failure: {other}");
                    CommitError::WorkerRevisionMismatch
                }
            })?;
        self.commit(actor_account_id, envelope, proposal).await
