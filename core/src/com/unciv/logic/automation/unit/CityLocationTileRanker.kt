...
object CityLocationTileRanker {
    ...
    fun getBestTilesToFoundCity(unit: MapUnit, distanceToSearch: Int? = null, minimumValue: Float): BestTilesToFoundCity {
        ...
        val uniques = unit.matchingUniquesSequence(UniqueType.FoundCity) + unit.matchingUniquesSequence(UniqueType.FoundPuppetCity)
        val possibleCityLocations = unit.getTile().tilesInDistanceSequence(range)
    ...
    private fun rankTileToSettle(newCityTile: Tile, civ: Civilization, nearbyCities: Sequence<City>,
        ...
        for (i in 0..2) {
                ...
                for (nearbyTile in newCityTile.tilesAtDistanceSequence(i)) {
                    tiles++
