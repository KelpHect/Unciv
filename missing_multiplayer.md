...
- [ ] Add deterministic fresh-process parity fixtures for every command family,
  ...
  Fresh packaged-JVM evidence covers 68 operations: handshake, game creation,
  ...
  spy movement and coups, and event choice.
  ...
  time remain replay-critical. The other 18 operations plus additional random
