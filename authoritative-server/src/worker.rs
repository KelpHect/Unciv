...
pub use protocol::{
    ...
    ChooseFreeTechnologyIntent, ChooseGreatPersonIntent, ChooseReligiousBeliefsIntent, CreatedGame,
    ...
    UseReligiousUnitIntent, WorkerCapabilities, WorkerManifest, WorkerRuleset,
};
