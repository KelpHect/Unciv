...
#[utoipa::path(
    post,
    path = "/api/v3/games/{game_id}/commands/set-city-governance",
    params(("game_id" = uuid::Uuid, Path)), security(("bearer_auth" = [])),
    request_body = SetCityGovernanceRequest,
    responses(
...
pub(super) async fn set_city_governance(
    State(state): State<AppState>,
    headers: HeaderMap,
    Path(game_id): Path<uuid::Uuid>,
    Json(request): Json<SetCityGovernanceRequest>,
    ...
    let accepted = state
        ...
        .execute_set_city_governance(
            ...
            CommandEnvelope {
                ...
                command: GameCommand::SetCityGovernance {
