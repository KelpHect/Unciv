...
three-major Domination game, invites and joins the second player, proves both
...
1. Person A registers on Android and creates a tiny Pangaea Domination game
   with three major civilizations and no city-states.
2. Person A invites Person B. Person B accepts on a separately authenticated
   client. Confirm the third faction remains server AI.
