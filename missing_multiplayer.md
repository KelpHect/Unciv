...
- [ ] Add deterministic fresh-process parity fixtures for every command family,
  ...
  Fresh packaged-JVM evidence covers 38 operations: handshake, game creation,
  ...
  research-completion acknowledgement, melee combat, and event choice.
  ...
  time remain replay-critical. The other 48 operations plus additional random
